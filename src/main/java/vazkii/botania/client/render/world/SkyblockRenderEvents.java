...
public final class SkyblockRenderEvents {
	...
	public static void onRender(RenderWorldLastEvent event) {
		...
		if(ConfigHandler.enableFancySkybox && world.provider.getDimension() == 43 && (ConfigHandler.enableFancySkyboxInNormalWorlds || WorldTypeSkyblock.isWorldSkyblock(Minecraft.getMinecraft().world))) {
